...
const getWeekSales = async () => {
    ...
    orders.forEach(order => {
        const actualOrderDay = format(order.createdAt, last7DatesFormat)
        const totalOrder = order.paymentData.transaction.subTotal + order.paymentData.transaction.shipping
